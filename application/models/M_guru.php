...
class M_guru extends CI_Model
{
    ...
    public function dt_setoran_detail($id)
    {
     ...
     //=============================== SETORAN AYAT ===============================
     public function dt_setoranayat()
     {
         $this->db->select('*');
         $this->db->from('setoran_rizaldyfauzan set_ayat');
         $this->db->join('santri s', 's.id_santri = set_ayat.id_santri');
         $query = $this->db->get();
         return $query->result_array();
     }
     ...
     public function dt_setoranayat_tambah()
     {
         $data = array(
             'id_santri' => $this->input->post('id_santri'),
             'ayatsetoran_rizaldyfauzan' => $this->input->post('ayatsetoran_rizaldyfauzan'),
         );
         return $this->db->insert('setoran_rizaldyfauzan', $data);
     }
     public function dt_setoranayat_edit($id)
     {
         $data = array(
             'id_santri' => $this->input->post('id_santri'),
             'ayatsetoran_rizaldyfauzan' => $this->input->post('ayatsetoran_rizaldyfauzan'),
         );
         $this->db->where('id_setoran_rizaldyfauzan', $id);
         return $this->db->update('setoran_rizaldyfauzan', $data);
     }
}
