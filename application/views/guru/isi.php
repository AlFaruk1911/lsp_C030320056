                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="small-box bg-info">
                            ...
                            <a href="<?php echo base_url('guru/santri') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="<?php echo base_url('guru/setoran') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Selamat Datang Guru</h3>
              ...
              <table id="datatable_01" class="table table-bordered">
                ...
                foreach ($setoran as $set) { ?>
                  <tr>
                    ...
                    <td>
                      <a href=<?php echo base_url("guru/setoran_detail/") . $set['id_setoran']; ?>>
...
//==================================== SETORAN AYAT ====================================
    ...
    ?>
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="card">
                    <div class="card-body">
                        <a href=<?php echo base_url("guru/setoran_ayat_tambah") ?> class="btn btn-primary" style="margin-bottom:15px">
                            Tambah Setoran Ayat<i class="bi bi-cash-stack"></i>
                        </a>
                        <table id="datatable_01" class="table table-bordered">
                            <thead>
                                <tr>
                            ...
                            <?php
                            foreach ($setoran_ayat as $set_ayat) { ?>
                                <tr>
                                    <td><?php echo $set_ayat['id_setoran_rizaldyfauzan'] ?></td>
                                    <td><?php echo $set_ayat['nama_santri'] ?></td>
                                    <td><?php echo $set_ayat['ayatsetoran_rizaldyfauzan'] ?></td>
                                    <td><?php echo $set_ayat['tgl_setoran_rizaldyfauzan'] ?></td>
                                    <td>
                                    <a href=<?php echo base_url("guru/setoran_ayat_edit/") . $set_ayat['id_setoran_rizaldyfauzan']; ?>> <i class="fas fa-pencil-alt"></i> </a>
                                    <a href=<?php echo base_url("guru/setoran_hapus/") . $set_ayat['id_setoran_rizaldyfauzan']; ?> onclick="return confirm('Yakin menghapus Setoran Ayat : <?php echo $set_ayat['nama_santri']; ?> ?');" ;><i class="fas fa-trash-alt"></i></a>
                                </td>
                                </tr>
                            <?php
                            }
    ...
    //--------------------------------- SETORAN AYAT TAMBAH ---------------------------------
    else if ($page == 'setoran_ayat_tambah') {
    ?>
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
            ...
            <section class="content">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo base_url('guru/setoran_ayat_tambah'); ?>" class="form-horizontal">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="setoran_ayat" class="col-sm-2 col-form-label">Setoran Ayat</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="ayatsetoran_rizaldyfauzan" id="ayatsetoran_rizaldyfauzan" value="<?php echo set_value('ayatsetoran_rizaldyfauzan'); ?>">
                                        <span class="badge badge-warning"><?php echo strip_tags(form_error('ayatsetoran_rizaldyfauzan')); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
    ...
    <?php
        ...
        //--------------------------------- SETORAN AYAT EDIT ---------------------------------
} else if ($page == 'setoran_ayat_edit') {
    ?>
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
            ...
            <section class="content">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo base_url('guru/setoran_ayat_edit/' . $set_ayat['id_setoran_rizaldyfauzan']); ?>" class="form-horizontal">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo form_dropdown('id_santri', $ddsantri, set_value('id_santri', $set_ayat['id_santri']), 'class=form-control'); ?>
                                        <span class="badge badge-warning"><?php echo strip_tags(form_error('id_santri')); ?></span>
                                    </div>
                                </div>
    
                                <div class="form-group row">
                                    <label for="tgl_setoran" class="col-sm-2 col-form-label">Setoran Ayat</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="ayatsetoran_rizaldyfauzan" id="ayatsetoran_rizaldyfauzan" value="<?php echo set_value('tgl_setoran', $set_ayat['ayatsetoran_rizaldyfauzan']); ?>">
                                        <span class="badge badge-warning"><?php echo strip_tags(form_error('ayatsetoran_rizaldyfauzan')); ?></span>
                                    </div>
                                </div>
